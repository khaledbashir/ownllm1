    ...
    seed: async function () {
        const apis = [
            // Jokes
            {
                ...
                isVerified: true,
                responseExample: '{"type":"single","joke":"Why do programmers prefer dark mode? Because light attracts bugs."}',
            },
            {
                category: "jokes",
        ...
        for (const api of apis) {
            try {
                ...
                console.error(`[PublicApiRegistry] Seed failed for ${api.name}:`, e.message);
            }
        }
