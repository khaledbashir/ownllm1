...
function MiniSparkline({ data, color = "#9ca3af" }) {
...
function ActivityIcon({ type }) {
  ...
  return (
    icons[type] || <Activity size={14} className="text-theme-text-secondary" />
  );
}
          ...
          <div className="h-full p-6 lg:p-8 rounded-xl bg-theme-bg-secondary border border-theme-border flex flex-col justify-between group hover:border-theme-text-secondary/20 transition-colors duration-200">
            <div>
              ...
              <p className="text-theme-text-secondary text-sm leading-relaxed max-w-xl">
                Configure autonomous agents to handle complex workflows. Define
                triggers, actions, and decision logic using the visual builder.
              </p>
            </div>
        ...
        <div className="col-span-12 lg:col-span-4">
          <div className="h-full p-6 rounded-xl bg-theme-bg-secondary border border-theme-border flex flex-col justify-between">
            <div>
              ...
              <div className="text-3xl font-bold text-theme-text-primary tracking-tight">
                1,240
              </div>
        ...
        <div className="col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-xs text-theme-text-secondary">
              Inject pre-defined prompts and context.
            </p>
          </button>
          ...
          >
            ...
            <p className="text-xs text-theme-text-secondary">
              Configure base AI persona and behavior.
            </p>
          </button>
