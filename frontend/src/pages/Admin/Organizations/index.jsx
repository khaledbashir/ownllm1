    ...
    <AdminLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage organization roles and permissions</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <div className="text-2xl font-bold text-gray-600">
              {organizations.filter(o => !o.role || o.role === 'default').length}
            </div>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
                ...
                <tr key={org.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-sm font-medium text-gray-900">{org.name || 'Unnamed'}</div>
                        <div className="text-sm text-gray-500">{org.userCount || 0} members</div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      org.role === 'admin' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                    }`}>
                      {org.role === 'admin' ? (
                        <>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Organization Roles</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p><strong>Admin:</strong> Full access to all features, can manage other organizations</p>
                <p className="mt-1"><strong>Default:</strong> Standard access to platform features</p>
              </div>
            </div>
          </div>
        </div>
