...
const ACTIVITY_FEED = [
  {
    action: "AI created 'Landing Page Wireframe'",
    time: "2 min ago",
    type: "create",
  },
  {
    action: "Document 'Q3_Report.pdf' embedded",
    time: "5 min ago",
    type: "embed",
  },
  {
    action: "Agent searched the web for pricing data",
    time: "12 min ago",
    type: "search",
  },
  {
    action: "New workspace 'Sales Deck' created",
    time: "1h ago",
    type: "workspace",
  },
...
export default function Dashboard() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6 lg:p-8">
      {/* Header */}
      ...
      <div className="grid grid-cols-12 gap-4 lg:gap-6">
        ...
        <div className="col-span-12 lg:col-span-6 row-span-2">
          <div className="h-full p-6 lg:p-8 rounded-3xl bg-gradient-to-br from-blue-600/20 via-purple-600/10 to-slate-900 border border-blue-500/20 backdrop-blur-sm hover:border-blue-500/40 transition-all duration-300 group cursor-pointer">
            ...
            <p className="text-slate-400 mb-6 text-lg">
              Create AI-powered workflows with natural language. Just describe
              what you want to build.
            </p>
            <Link
              to={paths.agents.builder()}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold hover:from-blue-400 hover:to-purple-500 transition-all duration-300 shadow-lg shadow-blue-500/25 group-hover:shadow-blue-500/40"
            >
              <Sparkles size={20} />
              Start Building
              <ChevronRight
        ...
        <div className="col-span-12 lg:col-span-6 grid grid-cols-3 gap-4">
          {/* Knowledge Base */}
          <div className="col-span-3 sm:col-span-1 p-5 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300">
          ...
          <div className="col-span-3 sm:col-span-1 p-5 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300">
            ...
            <div className="text-sm text-slate-400">+ Local Ollama</div>
          </div>
        ...
        {/* Recent Workspaces */}
        <div className="col-span-12 lg:col-span-6 p-5 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300">
          ...
          <div className="space-y-3">
            {RECENT_WORKSPACES.map((workspace, idx) => (
              <div
                key={idx}
                className="flex items-center justify-between p-3 rounded-xl bg-slate-900/50 hover:bg-slate-900 border border-slate-700/30 hover:border-slate-600/50 transition-all duration-200 cursor-pointer group"
              >
        ...
        {/* Activity Feed */}
        <div className="col-span-12 lg:col-span-6 row-span-2 p-5 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-white flex items-center gap-2">
          ...
          <div className="space-y-3 max-h-[320px] overflow-y-auto custom-scrollbar">
            {ACTIVITY_FEED.map((item, idx) => (
              <div
                key={idx}
                className="flex items-start gap-3 p-3 rounded-xl bg-slate-900/50 border border-slate-700/30 hover:border-slate-600/50 transition-all duration-200"
              >
        ...
        <div className="col-span-12 lg:col-span-6 grid grid-cols-2 gap-4">
          <Link
            to={paths.home()}
            className="p-5 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-blue-500/50 hover:bg-slate-800 transition-all duration-300 group"
          >
            <MessageSquare
              size={24}
          ...
          >
            ...
            />
            <div className="text-white font-medium">Embed Widget</div>
            <div className="text-sm text-slate-400">Add AI to your site</div>
          </Link>
        </div>
      </div>
