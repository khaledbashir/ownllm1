        ...
        >
          <div className="flex w-full flex-col">
            <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
              ...
              <div className="flex gap-x-8 border-b border-white border-opacity-10 mt-6">
                <button
                  onClick={() => setTab("llm")}
                  type="button"
              ...
              {tab === "audio" && (
                <div className="flex flex-col gap-y-12">
                  <TextToSpeechSelector settings={settings} />
                  <div className="h-[2px] w-full bg-white bg-opacity-10" />
                  <SpeechToTextSelector settings={settings} />
                </div>
              )}
            </div>
          </div>
