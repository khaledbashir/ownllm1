...
export default function SmartPluginsSettings() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setWorkspaces(ws);
      const initialSlug = workspaceSlug || (ws.length ? ws[0].slug : "");
  ...
  const schemaParse = useMemo(
    () => safeJsonParse(draft.schemaText),
    [draft.schemaText]
  );
        ...
        <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
          <div className="w-full flex flex-col gap-y-1 pb-6 border-white/10 border-b-2">
            ...
            <p className="text-xs leading-[18px] font-base text-theme-text-secondary mt-2">
              Build schema-driven plugins (no executable code). Active plugins
              are injected into workspace chat instructions.
            </p>
          </div>
                    ...
                    {plugins.map((p) => (
                      ...
                      >
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div
                            className={`text-[10px] ${p.active ? "text-green-400" : "text-theme-text-secondary"}`}
                          >
                            {p.active ? "ACTIVE" : "OFF"}
                          </div>
                        </div>
                  ...
                  <>
                    <div className="flex flex-col md:flex-row gap-3 justify-between md:items-center">
                      <div>
                        ...
                        <div className="text-xs text-theme-text-secondary">
                          Saved schema is validated server-side and must contain
                          no HTML/JS.
                        </div>
                      </div>
                      <div className="flex gap-2">
