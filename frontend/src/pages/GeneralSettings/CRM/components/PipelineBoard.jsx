    ...
    <div className="flex-1 overflow-x-auto overflow-y-hidden">
      <div className="flex h-full gap-4 px-4 pb-4 min-w-max">
        {stages.map((stage, index) => {
          ...
          const totalValue = stageCards.reduce(
          ...
          return (
            <div
              ...
              className={`flex flex-col w-[320px] rounded-2xl bg-theme-bg-primary border border-theme-sidebar-border transition-all duration-200 ${
                isDragOver
                  ? "ring-2 ring-theme-button-primary ring-opacity-50 bg-theme-bg-primary/50"
                  : ""
              }`}
            >
              {/* Column Header */}
              <div className="p-4 border-b border-theme-sidebar-border shrink-0">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-2.5 h-2.5 rounded-full ${accentColor}`}
                    />
