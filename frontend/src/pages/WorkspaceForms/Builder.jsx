  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (_form.fields) {
        try {
          setFields(
            typeof _form.fields === "string"
              ? JSON.parse(_form.fields)
              : _form.fields
          );
        } catch (e) {
      ...
      <div className="flex-1 h-full flex flex-col">
        ...
        <div className="bg-theme-bg-secondary border-b border-white/5 p-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <button
              onClick={() => navigate(paths.forms.dashboard())}
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mt-1">
                <span className="text-xs font-mono text-slate-500 bg-black/20 px-2 py-0.5 rounded">
                  ID: {uuid}
                </span>
              </div>
            </div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-700 rounded-lg text-white hover:bg-slate-600 transition-all"
            >
          ...
          {activeTab === "builder" && (
            <>
              ...
              <div className="w-64 bg-theme-bg-secondary border-r border-white/5 p-4 overflow-y-auto hidden md:block">
                <h3 className="text-slate-400 font-semibold mb-4 text-sm uppercase tracking-wider">
                  Fields
                </h3>
                          ...
                          {fields.length === 0 && (
                            <div className="text-center py-12 border-2 border-dashed border-slate-700 rounded-xl">
                              <p className="text-slate-500">
                                Drag fields here or select from sidebar
                              </p>
                            </div>
                          )}
                        ...
                        {responses.map((response) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="p-4 text-slate-400 text-sm truncate max-w-xs">
                                {preview}...
                              </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-theme-bg-secondary w-full max-w-lg p-6 rounded-xl border border-white/10 shadow-xl">
            ...
            <p className="text-slate-400 mb-4">
              Describe the form you want to create and let AI build the
              structure for you.
            </p>
            <textarea
              value={aiPrompt}
