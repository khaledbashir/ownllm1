...
import { ArrowRight, Lightning, Brain, Rocket, Star, Play, Check, Sparkle } from "@phosphor-icons/react";
...
export default function LandingClaude() {
    ...
    const features = [
        {
            ...
            description: "Your AI understands your business, remembers context, and learns from every interaction.",
            gradient: "from-violet-500 to-purple-600",
        },
        {
            icon: <Lightning size={28} weight="duotone" />,
            title: "Instant Document Generation",
            description: "From proposals to contracts—professionally formatted documents in seconds, not hours.",
            gradient: "from-amber-500 to-orange-600",
        },
        {
            icon: <Rocket size={28} weight="duotone" />,
            title: "Workflow Automation",
            description: "Build complex automations with a visual interface. Connect APIs, trigger actions, scale infinitely.",
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden">
            ...
            <nav className="relative z-50 flex items-center justify-between max-w-7xl mx-auto px-6 py-6">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-xl font-bold tracking-tight">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60">Nexus</span>
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <a href="#docs" className="text-white/60 hover:text-white transition-colors text-sm">Documentation</a>
                </div>
            ...
            {/* Hero Section */}
            <section ref={heroRef} className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-8 group hover:border-violet-500/50 transition-colors cursor-pointer">
                        ...
                        <span className="text-sm text-white/70">Now with GPT-4 Turbo Integration</span>
                        <ArrowRight size={14} className="text-white/40 group-hover:text-violet-400 group-hover:translate-x-1 transition-all" />
                    </div>
                    ...
                    <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
                        The intelligent operations platform that transforms how you create proposals,
                        manage documents, and automate workflows. Built for teams that move fast.
                    </p>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-8 text-white/30 text-sm">
                        <div className="flex items-center gap-2">
                            <div className="flex -space-x-2">
                                {[1, 2, 3, 4, 5].map(i => (
                                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-400 to-purple-600 border-2 border-[#0a0a0f]" />
                                ))}
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-[#12121a] to-[#0a0a0f] p-8 aspect-video flex flex-col">
                            <div className="flex gap-6 flex-1">
                                ...
                                <div className="w-48 bg-white/5 rounded-xl p-4 space-y-3">
                                    {['Dashboard', 'Proposals', 'Documents', 'Workflows'].map((item, i) => (
                                        <div key={item} className={`px-3 py-2 rounded-lg text-sm ${i === 1 ? 'bg-violet-500/20 text-violet-300' : 'text-white/40'}`}>
                                            {item}
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="flex-1 bg-white/5 rounded-xl p-6">
                                    <div className="flex items-center justify-between mb-6">
                                        <div className="text-lg font-semibold text-white/80">Recent Proposals</div>
                                        <div className="px-3 py-1.5 rounded-lg bg-violet-500/20 text-violet-300 text-sm">+ New</div>
                                    </div>
                                    <div className="space-y-3">
                                        {['Enterprise SaaS Partnership', 'Q4 Marketing Campaign', 'Product Launch Strategy'].map((name, i) => (
                                            <div key={name} className="flex items-center justify-between p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                                                <div>
                                                    <div className="text-white/70 text-sm">{name}</div>
                                                    <div className="text-white/30 text-xs mt-1">Updated 2h ago</div>
                                                </div>
                                                <div className={`px-2 py-1 rounded text-xs ${i === 0 ? 'bg-green-500/20 text-green-300' : i === 1 ? 'bg-amber-500/20 text-amber-300' : 'bg-blue-500/20 text-blue-300'}`}>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-white/40 max-w-2xl mx-auto">
                            A unified platform that brings AI-powered automation to every aspect of your business operations.
                        </p>
                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6">
                    <div className="relative bg-gradient-to-br from-violet-600/20 to-purple-600/20 border border-violet-500/30 rounded-3xl p-12 text-center overflow-hidden">
                        ...
                        <p className="text-white/50 mb-8 max-w-xl mx-auto">
                            Join thousands of teams already using NexusAI to automate their operations and close deals faster.
                        </p>
                        ...
                        <p className="text-white/30 text-sm mt-6">
                            <Check size={16} className="inline mr-1" /> No credit card required
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-white/60 text-sm">© 2024 NexusAI. All rights reserved.</span>
                        </div>
