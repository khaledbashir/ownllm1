                ...
                <div>
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mt-4">
                    <p className="text-sm text-blue-400">
                      Billing management and plan upgrades will be available
                      soon. Contact support for plan changes.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="bg-white/5 rounded-lg p-6">
                    <div className="mb-4">
                      <p className="text-sm text-theme-text-secondary mb-2">
                        Set the maximum number of users allowed in this
                        organization. Leave empty for unlimited seats.
                      </p>
                    </div>
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
                    <p className="text-sm text-yellow-400">
                      <strong>Note:</strong> Reducing the seat limit below the
                      current number of users will prevent new user additions
                  ...
                  <div className="bg-white/5 rounded-lg p-6">
                    ...
                    <div className="pt-4">
                      <p className="text-sm text-gray-400">
                        Customization features will be available in a future
                        update.
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-white/5 rounded-lg p-6 space-y-4">
                    ...
                    <div className="pt-4">
                      <p className="text-sm text-gray-400">
                        Notification features will be available in a future
                        update.
                      </p>
                    </div>
                  </div>
