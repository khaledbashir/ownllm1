            ...
            <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 text-center">
                    ...
                    <p className="text-gray-400 mb-6">
                        We sent a magic sign-in link to <span className="text-white font-medium">{email}</span>.
            ...
            <div className="max-w-md w-full bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
                <div className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400">Sign in to view your proposals and projects</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-4 border-t border-white/5">
                            <button
                                type="button"
                                onClick={() => {
                                    localStorage.setItem("anythingllm_client_auth", "dev-bypass-token");
