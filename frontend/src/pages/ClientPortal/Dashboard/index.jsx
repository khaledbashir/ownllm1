        ...
        <div className="p-8 max-w-7xl mx-auto animate-fade-in-up">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-400">Welcome back. Here is an overview of your projects.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-[#0a0a0a] border border-white/5 p-6 rounded-2xl relative overflow-hidden group hover:border-blue-500/30 transition-all">
                    ...
                    <p className="text-sm font-medium text-gray-400 mb-1">Active Proposals</p>
                ...
                <div className="bg-[#0a0a0a] border border-white/5 p-6 rounded-2xl relative overflow-hidden group hover:border-emerald-500/30 transition-all">
                    ...
                    <p className="text-sm font-medium text-gray-400 mb-1">Signed Projects</p>
                ...
                <div className="bg-[#0a0a0a] border border-white/5 p-6 rounded-2xl relative overflow-hidden group hover:border-purple-500/30 transition-all">
                    ...
                    <p className="text-sm font-medium text-gray-400 mb-1">Pending Actions</p>
                ...
                {loading ? (
                    ...
                    <div className="divide-y divide-white/5">
                        ...
                        {filteredProposals.map((proposal) => (
                            <div key={proposal.id} className="grid grid-cols-12 px-6 py-4 items-center hover:bg-white/[0.02] transition-colors group cursor-pointer" onClick={() => {/* Navigate to project */ }}>
                                ...
                                <div className="col-span-2 text-right text-gray-500 text-sm flex items-center justify-end gap-2">
                                    {proposal.date}
                                    <ArrowRight size={16} className="text-gray-600 group-hover:text-blue-400 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0" />
                                </div>
                            </div>
                        ))}
                    </div>
