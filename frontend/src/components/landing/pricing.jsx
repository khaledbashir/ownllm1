      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-zinc-300 font-normal">
            One-time build fee. Standard $400/mo retainer for hosting,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="p-8 bg-white/[0.02] border border-white/5 rounded-lg">
              ...
              <p className="text-xs text-zinc-300 leading-relaxed mb-6">
                Post-launch, we ensure your infrastructure stays sharp. Choose
                between an active retainer for security and feature updates or
