        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-[10px] uppercase font-bold tracking-widest text-white/70">
              Fully Customizable White-Label AI v1.9.1
            </span>
          </motion.div>
          ...
          >
            ...
            . <strong className="text-white font-semibold">Your Brand</strong>,{" "}
            <strong className="text-white font-semibold">Your Logo</strong>, and{" "}
            <strong className="text-white font-semibold">
              Unlimited Workspaces
            </strong>
            . Aggregate 25+ AI models including GPT-4o, Claude 3.5, and Gemini
            into one secure, deterministic hub.
          </motion.p>
