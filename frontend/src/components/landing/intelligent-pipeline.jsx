...
const PIPELINE_FEATURES = [
  ...
  },
  {
    ...
    icon: Terminal,
    auditDetail:
      "Cheerio Scraper + YouTube Transcript API + Metadata Extraction",
  },
  {
    ...
    icon: Calculator,
    auditDetail:
      "Financial Logic Node + Real-time Margin Control + Currency Support",
  },
  {
...
export function IntelligentPipeline() {
  return (
    <section
      id="editor"
      className="py-32 bg-zinc-950 border-t border-white/5 relative overflow-hidden"
    >
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-24">
          ...
          <p className="text-lg text-zinc-300 font-normal leading-relaxed">
            ...
            is not just a tool. It's an entire logic ecosystem designed to get
            you paid.
          </p>
        </div>
