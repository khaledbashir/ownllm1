...
const VALUE_PROPS = [
    {
        ...
        icon: Palette,
        details: ["Custom Logos & Assets", "Themable UI Components", "Personalized System Prompts"]
    },
    {
        ...
        icon: Users,
        details: ["Infinite Workspaces", "Multi-Tenant Isolation", "Admin & Member Roles"]
    },
    {
        ...
        icon: Globe,
        details: ["GPT-4o & Claude 3.5 Ready", "Local Model Support (Ollama)", "Enterprise-Grade Security"]
    }
]
