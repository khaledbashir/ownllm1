      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <div className="flex flex-col -gap-1">
            ...
            <span className="text-[8px] font-bold tracking-[0.2em] uppercase text-zinc-400">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <Link to="/login">
            <Button
              variant="ghost"
              className="text-[10px] font-bold uppercase tracking-widest text-white/70 hover:text-white hover:bg-white/5"
            >
              Sign In
            </Button>
          </Link>
        ...
        >
          {[
            ...
            <a
              key={item.name}
              href={item.href}
              className="text-sm font-bold uppercase tracking-widest text-zinc-300 hover:text-white transition-colors"
