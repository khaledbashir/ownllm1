...
export default function TextToSpeechSelector({ settings }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex w-full">
            <div className="flex flex-col w-full px-1 md:pr-[50px] md:py-6 py-16">
                <div className="w-full flex flex-col gap-y-1 pb-6 border-white light:border-theme-sidebar-border border-b-2 border-opacity-10">
                    ...
                    <p className="text-xs leading-[18px] font-base text-white text-opacity-60">
                        Specify which text-to-speech provider you want to use.
                    </p>
                </div>
                <div className="w-full justify-end flex">
                    {hasChanges && (
                        <CTAButton className="mt-3 mr-0 -mb-14 z-10" onClick={() => handleSubmit()}>
