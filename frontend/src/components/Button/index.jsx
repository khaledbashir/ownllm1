...
export default function Button({
  ...
  const variants = {
    ...
    secondary:
      "bg-theme-bg-secondary hover:bg-theme-bg-container text-white border-theme-sidebar-border",
    danger: "bg-red-600 hover:bg-red-700 text-white border-transparent",
    success: "bg-green-600 hover:bg-green-700 text-white border-transparent",
    ghost:
      "bg-transparent hover:bg-theme-bg-secondary text-theme-text-secondary hover:text-white border-transparent",
  };
