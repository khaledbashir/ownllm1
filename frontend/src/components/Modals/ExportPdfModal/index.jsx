  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE}/workspace/${slug}/forms/${formUuid}/responses/${responseId}/export`,
        {
          method: "POST",
          headers: {
          ...
          {loading ? (
            ...
            <div className="text-center p-4 text-slate-400">
              ...
              <p className="text-sm mt-2">
                Create templates in Settings &gt; Document Templates first.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSelectedTemplate(
                      templates.find((t) => t.id === parseInt(e.target.value))
                    )
                  }
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Form fields matching <code>{"{{field_id}}"}</code> in the
                  template will be auto-populated.
                </p>
              </div>
