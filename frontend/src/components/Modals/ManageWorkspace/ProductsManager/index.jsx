                        ...
                        {editingId === product.id ? (
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => updateProduct(product.id, products.find(p => p.id === product.id))}
                                            disabled={saving}
                                            className="p-2 text-green-400 hover:bg-green-400/10 rounded disabled:opacity-50"
                                        >
                                            <FloppyDisk className="w-5 h-5" />
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="text-lg font-semibold text-green-400">
                                        ...
                                        <span className="text-sm text-white/40 ml-1">
                                            ({PRICING_TYPES.find(t => t.value === product.pricingType)?.label || product.pricingType})
                                        </span>
                                    </div>
                                    {product.description && (
...
function ProductForm({ product, onChange }) {
    ...
    return (
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
                <label className="block text-white/60 text-sm mb-1">Features / Deliverables</label>
