...
- [x] **Update User Management Page**
   ...
   - [x] Add organization assignment:
     - Dropdown to select organization (admin only)
     - Organization list loaded from API
     - Organization ID saved to user record
     - Update Admin model to support organizationId
